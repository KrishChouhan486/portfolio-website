...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="text-center p-20 bg-white ">
      <h3 className="text-gray-500 text-2xl font-[anzo3]">
        © anzo.studio 2025 | designed and developed
      </h3>

      <div className="rotatetext mt-20 ">
        <h1 className="text-[42vw] text-black font-[anzo4] uppercase leading-[35vw]">
          IMPACTFUL
        </h1>
      </div>
      ...
      <div className="flex items-center justify-center mt-20 scale-75">
        <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="1080" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
          <g>
      ...
      <div className="h-1 w-1/3 relative left-1/2 -translate-x-1/2 bg-black mt-12">
